...
const WORDS_DB = {
    ...
    { word: "GILLI", hint: "kabaddi, prakash raj" },
    { word: "THUPPAKKI", hint: "bomb squad, table fan" },
    { word: "KATHTHI", hint: "farmer, machete" },
    { word: "THERI", hint: "daughter, bakery" },
    { word: "MERSAL", hint: "triple role, medical scam" },
    { word: "BIGIL", hint: "football, coach" },
    { word: "MASTER", hint: "college, hostel" },
    { word: "BEAST", hint: "mall, terrorists" },
    { word: "VARISU", hint: "family, business" },
    { word: "LEO", hint: "dash, bloodshed" },
    { word: "SARKAR", hint: "businessman, aadhi" },
    { word: "NANBAN", hint: "college, friendship" },
    { word: "VEERAM", hint: "family, comedy" },
    { word: "VEDALAM", hint: "revenge, snake" },
    { word: "VISWASAM", hint: "family, sentiment" },
    { word: "NERKONDA PAARVAI", hint: "blind, court" },
    { word: "YENNAI ARINDHAAL", hint: "police, track" },
    { word: "VALIMAI", hint: "action, temple" },
    { word: "THUNIVU", hint: "cargo, container" },
    { word: "BILLA", hint: "gangster, remake" },
    { word: "MANKATHA", hint: "gambling, father" },
    { word: "ARAMBAM", hint: "heist, mumbai" },
    { word: "VIVEKAM", hint: "spy, intelligence" },
    { word: "SOORARAI POTTRU", hint: "farmer, flying" },
    { word: "JAI BHIM", hint: "tribal, court" },
    { word: "VIP", hint: "coolie, engineering" },
    { word: "VIP 2", hint: "architects, construction" },
    { word: "SINGAM", hint: "police, whistle" },
    { word: "SINGAM 2", hint: "myanmar, villain" },
    { word: "ANJAAN", hint: "math, gangster" },
    { word: "24", hint: "time travel, watch" },
    { word: "VAARANAM AAYIRAM", hint: "army, heart" },
    { word: "ASURAN", hint: "father-son, caste" },
    { word: "KARNAN", hint: "village, collector" },
    { word: "THIRUCHITRAMBALAM", hint: "brother, sentiment" },
    { word: "MAARI", hint: "rowdy, comedy" },
    { word: "VADACHENNAI", hint: "gangster, north chennai" },
    { word: "MARYAN", hint: "ocean, desert" },
    { word: "SHIVAJI", hint: "boss, senthil" },
    { word: "ENTHIRAN", hint: "robot, chitti" },
    { word: "2.0", hint: "bird, mobile" },
    { word: "PETTA", hint: "hostel, kullu" },
    { word: "KAALA", hint: "mumbai, matka" },
    { word: "DARBAR", hint: "police, sunil" },
    { word: "ANNAATTHE", hint: "sister, village" },
    { word: "JAILER", hint: "grandson, tiger" },
    { word: "DASHAVATHARAM", hint: "10 roles, evolution" },
    { word: "VISWAROOPAM", hint: "cia, terrorism" },
    { word: "PAPANASAM", hint: "remake, father" },
    { word: "VIKRAM", hint: "agents, chase" },
    { word: "ANNIYAN", hint: "multiple personality" },
    { word: "DEIVATHIRUMAGAL", hint: "autism, father" },
    { word: "RAVANAN", hint: "forest, chase" },
    { word: "I", hint: "bodybuilder, love" },
    { word: "VINNAITHAANDI VARUVAAYAA", hint: "camera, love" },
    { word: "MAANADU", hint: "trapped, city" },
    { word: "THANI ORUVAN", hint: "cop, ego" },
    { word: "MIRUTHAN", hint: "zombie, horror" },
    { word: "KOMALI", hint: "comedy, sports" },
    { word: "PARUTHIVEERAN", hint: "village, love" },
    { word: "MADRAS", hint: "wall, north chennai" },
    { word: "THEERAN", hint: "cop, highway" },
    { word: "KADAIVEERAN", hint: "farm, festival" },
    { word: "SULTHAN", hint: "boxing, ring" },
    { word: "SARDAR", hint: "spy, father-son" },
    { word: "VIRUMAN", hint: "sarpanch, village" },
    { word: "VARUTHAPADATHA VALIBAR", hint: "comedy, village" },
    { word: "DRISHYAM", hint: "remake, family" },
    { word: "MR LOCAL", hint: "comedy, marriage" },
    { word: "DON", hint: "college, hostel" },
    { word: "DOCTOR", hint: "medical, comedy" },
    { word: "PRINCE", hint: "love, college" },
    { word: "IRUVAR", hint: "politics, mgr" },
    { word: "ALAI PAYUTHE", hint: "love, rain" },
    { word: "RAJA RANI", hint: "marriage, death" },
    { word: "LOVE TODAY", hint: "phone swap, couple" },
    { word: "DRAGON", hint: "college, topper" },
    { word: "COMALI", hint: "coma, hospital" },
    { word: "KANCHANA", hint: "horror, comedy" },
    { word: "MUNI", hint: "ghost, comedy" },
    { word: "CHENNAI 600028", hint: "cricket, friends" },
    { word: "SAROJA", hint: "kidnap, cricket" },
    { word: "VENNILA KABADI KULU", hint: "kabadi, marriage" },
    { word: "PUDUPETTAI", hint: "gangster, village" },
    { word: "VAANAM", hint: "sky, kidnap" },
    { word: "RATCHASAN", hint: "horror, forest" },
    { word: "PISASU", hint: "ghost, family" },
    { word: "ULLAM KETKUME", hint: "college, love" },
    { word: "MINNALE", hint: "love, marriage" },
    { word: "SAMI", hint: "village, revenge" },
    { word: "PERAZHAGAN", hint: "village, love" },
    { word: "ARANMANAI", hint: "horror, comedy" },
    { word: "ARANMANAI 2", hint: "sequel, ghost" },
    { word: "NAKKU MUKKA", hint: "comedy, marriage" },
    { word: "KANDA NAAL MUDHAL", hint: "love, rain" },
    { word: "UNNALE UNNALE", hint: "love, songs" },
    { word: "JAYAM", hint: "college, love" },
    { word: "GEMINI", hint: "gangster, remake" },
    { word: "KOVIL", hint: "temple, love" },
    { word: "KALYANAM", hint: "marriage, comedy" },
    { word: "KADHAL KONDAEN", hint: "obsession, love" },
    { word: "SIVA MANASULA SAKTHI", hint: "comedy, village" },
    { word: "RAJA RANI 2", hint: "sequel, marriage" },
    { word: "KADHALIL VIZHUNTEN", hint: "love, police" },
    { word: "CHARLIE CHAPLIN", hint: "comedy, brothers" },
    { word: "SUNDARAPANDIAN", hint: "village, family" },
    { word: "KALAKALAPPU", hint: "comedy, marriage" },
    { word: "THILLALANGADI", hint: "comedy, village" },
    { word: "VETRI SELVAN", hint: "love, college" },
    { word: "PANDIANAADU", hint: "village, family" },
    { word: "MAPPILLAI", hint: "remake, marriage" },
    { word: "THUPARIYUM SITHARGAL", hint: "police, mystery" },
    { word: "DHURUVANGAL PATHINARU", hint: "police, serial killer" },
    { word: "ANDHAVAN KATTALAI", hint: "village, revenge" },
    { word: "YAVARUM NALAM", hint: "mystery, hospital" },
    { word: "KADHALAR DHINAM", hint: "love, technology" },
    { word: "PRIYAMANA THOZHI", hint: "friendship, love" },
    { word: "SAMI 2", hint: "sequel, family" },
    { word: "KARUNAN", hint: "village, politics" },
    { word: "PAKKIRI", hint: "gangster, police" },
    { word: "KUTTY PULI", hint: "comedy, village" },
    { word: "PULI", hint: "fantasy, tiger" },
    { word: "KAASHMORA", hint: "comedy, village" },
    { word: "JAYAM KONDAN", hint: "village, revenge" },
    { word: "THIRUPPACHI", hint: "village, love" },
    { word: "THIRUMALAI", hint: "village, family" },
    { word: "SUTHA", hint: "village, comedy" },
    { word: "KANDAKOTTAI", hint: "village, family" },
    { word: "CHITTHIRAM PESUTHADI", hint: "love, accident" }
]},
