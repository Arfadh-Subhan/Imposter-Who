...
const WORDS_DB = {
    ...
    { word: "MEIYAZHAGAN", hint: "nostalgic, village" },
    ...
    { word: "POKKIRI", hint: "gangster, police" },
    ...
    // NEW ADDED MOVIES (NO DUPLICATES)
    { word: "PANCHATHANTHIRAM", hint: "friends, comedy" },
    { word: "MAAS", hint: "gangster, action" },
    { word: "BHASHA", hint: "don, mumbai" },
    { word: "VIKRAM VEDHA", hint: "cop, gangster" },
    { word: "LIK", hint: "suspense, thriller" },
    { word: "COOLIE", hint: "railway, porter" },
    { word: "GREATEST OF ALL TIME", hint: "GOAT, agent" },
    { word: "AMARAN", hint: "army, martyr" },
    { word: "YOUTH", hint: "college, friendship" },
    { word: "VAATHI", hint: "teacher, students" }
]},
